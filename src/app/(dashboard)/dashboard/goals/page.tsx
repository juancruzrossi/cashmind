...
function GoalsPage() {
  ...
  const { goals, addGoal, updateGoal, deleteGoal, contributeToGoal } = useFinanceStore();
  ...
  const handleContribute = () => {
    if (selectedGoal && contributeAmount) {
      contributeToGoal(selectedGoal.id, parseFloat(contributeAmount));
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-500">{completedGoals.length}</p>
              </div>
        ...
        <DialogContent className="sm:max-w-[500px] glass">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button type="submit" className="bg-gradient-to-r from-primary to-chart-2">
        ...
        <DialogContent className="sm:max-w-[400px] glass">
          ...
          <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-secondary/30">
                ...
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-emerald-500">
                    {formatCurrency(selectedGoal.currentAmount + (parseFloat(contributeAmount) || 0))}
                  </span>
                </div>
            ...
            <div className="flex justify-end gap-3">
              ...
              <Button onClick={handleContribute} className="bg-gradient-to-r from-primary to-chart-2">
                Aportar
              </Button>
            </div>
          </div>
