...
function BudgetsPage() {
  ...
  const { budgets, transactions, addBudget, updateBudget, deleteBudget } = useFinanceStore();
  ...
  const healthyCount = budgetsWithSpent.filter((b) => b.spent <= b.limit * 0.8).length;
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          >
                            <PiggyBank className="w-5 h-5" style={{ color: budget.color }} />
                          </div>
                          <div>
                      ...
                      <div className="space-y-3">
                        ...
                        {!isOver && (
                          <p className="text-sm text-muted-foreground">
                            Disponible: {formatCurrency(budget.limit - budget.spent)}
                          </p>
                        )}
                      </div>
                    </CardContent>
